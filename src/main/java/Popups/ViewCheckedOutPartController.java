...
public class ViewCheckedOutPartController {
    ...
    public void goBack() {
        sceneViewCheckedOutPart.fireEvent(new WindowEvent(sceneViewCheckedOutPart.getScene().getWindow(), WindowEvent.WINDOW_CLOSE_REQUEST));
    }
