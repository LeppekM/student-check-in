...
import Tables.HistoryInventoryTable;
...
public class ViewHistoryPartController {
    ...
    public void goBack() {
        sceneViewHistoryPart.fireEvent(new WindowEvent(sceneViewHistoryPart.getScene().getWindow(), WindowEvent.WINDOW_CLOSE_REQUEST));
    }
