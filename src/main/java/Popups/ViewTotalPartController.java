...
import Tables.CompleteInventoryTable;
 ...
 */
public class ViewTotalPartController {
    ...
    public void populate(CompleteInventoryTable.CIRow row) {
        ...
        serialNumberField.setText(row.getSerialNumber().getValue());
     ...
     */
    public void goBack() {
        sceneViewTotalPart.fireEvent(new WindowEvent(sceneViewTotalPart.getScene().getWindow(), WindowEvent.WINDOW_CLOSE_REQUEST));
    }
